...
local function OnPlayerConnecting(name, setKickReason, deferrals)
    ...
    deferrals.update(string.format('Hello %s. Validating Your Plane Ticket at the Gate', name))
    ...
    deferrals.update(string.format('Hello %s! We are checking your passport status..', name))
