...
-- Added by Sam (1/16/22)
--[[ RegisterNetEvent('police:client:ClosestPed', function()
    local PlayerPeds = {}
    ...
    QBCore.Functions.Notify("closestPed", "error")
end) ]]
            ...
            QBCore.Functions.TriggerCallback('QBCore:HasItem', function(result)
                if result then 
                    ...
                    if not IsPedInAnyVehicle(GetPlayerPed(player)) and not IsPedInAnyVehicle(PlayerPedId()) then
                        ...
                        QBCore.Functions.Notify("You can\'t shackle someone in a vehicle", "error")
                    end
                else
                    QBCore.Functions.Notify("You don\'t have schackles on you", "error")
                end
            end, "shackles")
        else
            QBCore.Functions.Notify("No one nearby!", "error")
